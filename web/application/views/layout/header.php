...
<body id="body">
	...
	<aside id="sidebar" class="column" >
		...
		<ul class="toggle">
			<li class="icn_my_application"><?php echo anchor('/',  lang('v_console'));?></li>
			<li class="icn_add_apps"><?php echo anchor('/manage/product/create', lang('m_new_app'));?></li>
			<li class="icn_app_channel"><?php echo anchor('/manage/channel/', lang('m_channelManagement'));?></li>
		</ul>
		<?php endif;?>		
		<?php if(isset($product)):?>
			...
			<?php if(isset($productList)):?>
				...
				onchange='changeProduct(value)'>
							<?php foreach($productList->result() as $row){?>
								<option <?php if($product->id == $row->id) echo 'selected';?>
		...
		<ul class="toggle">
			<li class="icn_basic_statis"><?php echo anchor('/report/productbasic/view/'.$product->id, lang('m_rpt_dashboard'));?></li>
		...
		<ul class="toggle">
			<li class="icn_equipment"><?php echo anchor('/report/device/', lang('m_rpt_devices'));?></li>
			<li class="icn_system"><?php echo anchor('/report/os/', lang('m_rpt_os'));?></li>
			<li class="icn_resolution"><?php echo anchor('/report/resolution/', lang('m_rpt_resolution'));?></li>
			<li class="icn_operator"><?php echo anchor('/report/operator/', lang('m_rpt_carriers'));?></li>
			<li class="icn_network"><?php echo anchor('/report/network/', lang('m_rpt_networking'));?></li>
		</ul>
		...
		<ul class="toggle">
			<li class="icn_mangageuser"><?php echo anchor('/user/', lang('m_userManagement'));?></li>
			<li class="icn_managerole"><?php echo anchor('/user/rolemanage/', lang('m_roleManagement'));?></li>
			<!-- 
			<li class="icn_manaresource"><?php echo anchor('/user/resourcemanage/', lang('m_resourceManagement'));?></li> -->
			<li class="icn_manacategory"><?php echo anchor('/user/applicationManagement/', lang('m_appType'));?></li>
		...
		<ul><hr/>
		 <br/>
			...
			{ echo 'http://dev.cobub.com/zh/docs/cobub-razor/';}
				...
				target="_blank"><?php echo lang('m_developerGuide');?></a></li>
		</ul>
		<footer>
			<hr />
			<!-- 
